<template>
	<div class="shop-header">
		...
		<div class="shop-header-discounts" v-if='info.supports' @click="toggleSuppoerShow">
			<div class="discounts-left" >
				<div class="activity" :class="supporClasses[info.supports[0].type]">
					<span class="content-tag">
		...
		<transition name="fade">
			<div class="activity-sheet" v-show="suppoerShow">
				<div class="activity-sheet-content">
					<h2 class="activity-sheet-title">优惠活动</h2>
					<ul class="list">
						<li class="activity-item" :class="supporClasses[info.supports[index].type]" 
						 v-for ='(v,index) in info.supports' :key='index'>
							<span class="content-tag">
					...
					<div class="activity-sheet-close" @click="toggleSuppoerShow">
						<span class="iconfont icon-guanbi"></span>
					</div>
				</div>
...
<script>
	...
	export default{
		data(){
			return{
				supporClasses:['activity-green','activity-red','activity-orange'],
				shopShow:false,
				suppoerShow:false,				
			}
		},
		...
		methods:{
			...
			toggleSuppoerShow(){
				this.suppoerShow = !this.suppoerShow
			},
		},
	}
</script>
